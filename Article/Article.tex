...
In this paper we propose a new approach to improve compression performance of one such extension, cost considering Huffman code,   %the data transmission technique by improving the representation of Huffman code with the use of a 
